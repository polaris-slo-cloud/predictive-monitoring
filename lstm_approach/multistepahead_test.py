...
from multistepahead_model_evaluation import rmse
from multistepahead_model_evaluation import rmse_perc
from multistepahead_model_evaluation import rmse_perc_eps
from multistepahead_model_evaluation import true_val
from multistepahead_model_evaluation import true_val_max
from multistepahead_model_evaluation import true_val_min
from multistepahead_model_evaluation import true_val_ratio_pos
...
exp_name = "LSTM-multivariate-test_v2" #.format(jobname=jobname)
...
def main():
    ...
    metrics = [('rmse', rmse), 
               ('rmse_p', rmse_perc), 
               ('rmse_p_eps', rmse_perc_eps), 
               ('true_val', true_val), 
               ('true_val_max', true_val_max), 
               ('true_val_min', true_val_min), 
               ('true_val_ratio_pos', true_val_ratio_pos)]
    for metric in metrics:
        score, scores = evaluate_forecast(real_values, predictions,  metric[1])
